...
def promethee_v(dataset, W, Q, S, P, F, sort = True, criteria = 1, cost = [], budget = 0, forbidden = [], iterations = 500, verbose = True):
    ...
    ga = genetic_algorithm(population_size = 100, mutation_rate = 0.1, elite = 0, min_values = [0]*flow.shape[0], max_values = [1]*flow.shape[0], eta = 1, mu = 1, generations = iterations, target_function = target_function, verbose = verbose)
